...
def addDatabankEntries(dbname, dict_entries, verbose=True):
    ...
    dict_entries.pop("download_url", None)  # generated by fetch_hitemp
    dict_entries.pop("download_date", None)  # generated by fetch_hitemp
    dict_entries.pop("wavenumber_min", None)  # generated by fetch_hitemp
    dict_entries.pop("wavenumber_max", None)  # generated by fetch_hitemp
