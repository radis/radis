...
columns_GEISA = OrderedDict(
    [
        ...
        ("int", ("S11", str, "intensity at 296K", "cm-1/(molecule/cm-2)")),
        ("airbrd", ("S6", float, "air-broadened half-width at 296K", "cm-1.atm-1")),
        ("El", ("S10", float, "lower-state energy", "cm-1")),
        ("globu", ("S25", str, "electronic and vibrational global upper quanta", "")),
        ("globl", ("S25", str, "electronic and vibrational global lower quanta", "")),
        ...
        ("isoG", ("S3", int, "GEISA isotope number", "")),
        ("mol", ("S3", int, "GEISA molecular number", "")),
        ("idG", ("S3", str, "Internal GEISA code for the data identification", "")),
        ("id", ("S2", int, "Hitran molecular number", "")),
        ("iso", ("S1", int, "Hitran isotope number", "")),
        ("A", ("S10", float, "Einstein A coefficient", "s-1")),
        ("selbrd", ("S7", float, "self-broadened half-width at 296K", "cm-1.atm-1")),
        ("Pshft", ("S9", float, "air pressure-induced line shift at 296K", "cm-1.atm-1")),
        ("Tdppair", ("S6", float, "temperature-dependance exponent for air pressure-induced line shift", "")),
        ("ierrA", ("S10", float, "estimated accuracy on the line position", "cm-1")),
        ("ierrB", ("S11", str, "estimated accuracy on the intensity of the line", "cm-1/(molecule/cm-2)")),
        ("ierrC", ("S6", float, "estimated accuracy on the air collision halfwidth", "cm-1.atm-1")),
        ("ierrF", ("S4", float, "estimated accuracy on the temperature dependence coefficient of the air-broadening halfwidth", "")),
        ("ierrO", ("S9", float, "estimated accuracy on the air pressure shift of the line transition at 296K", "cm-1.atm-1")),
        ("ierrR", ("S6", float, "estimated accuracy on the temperature dependence coefficient of the air pressure shift", "")),
        ("ierrN", ("S7", float, "estimated accuracy on the self-broadened at 296K", "cm-1.atm-1")),
        ("Tdpself", ("S4", float, "temperature-dependance exponent for self-broadening halfwidth", "")),
        ("ierrS", ("S4", float, "estimated accuracy on the temperature dependence coefficient of the self-broadening halfwidth", "")),
        ("Pshfts", ("S8", float, "self pressure-induced line shift at 296K", "cm-1.atm-1")),
        ("ierrT", ("S8", float, "estimated accuracy on the self-pressure shift of the line transition at 296K", "cm-1.atm-1")),
        ("Tdpnself", ("S4", float, "temperature-dependance exponent for self pressure-induced line shift", "")),
        ("ierrU", ("S4", float, "estimated accuracy on the temperature dependence coefficient of the self pressure shift", "")),
    ]
)
...
equilibrium_columns = OrderedDict(
    [
        # name  # format  # type  # description  # unit
        ("wav", ("S12", float, "vacuum wavenumber", "cm-1")),
        ("int", ("S11", float, "intensity at 296K", "cm-1/(molecule/cm-2)")),
        ("airbrd", ("S6", float, "air-broadened half-width at 296K", "cm-1.atm-1")),
        ("iso", ("S3", int, "GEISA isotope number", "")),
        ("mol", ("S3", int, "GEISA molecular number", "")),
        ("id", ("S3", str, "Internal GEISA code for the data identification", "")),
        ("selbrd", ("S7", float, "self-broadened half-width at 296K", "cm-1.atm-1")),
        ("Pshft", ("S9", float, "air pressure-induced line shift at 296K", "cm-1.atm-1")),
        ("Pshfts", ("S8", float, "self pressure-induced line shift at 296K", "cm-1.atm-1")),
    ]
