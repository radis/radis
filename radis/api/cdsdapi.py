...
columns_cdsdhitemp = OrderedDict(
    [
        ...
        ("Tdpsel", ("S5", float, "temperature dependance exponent for gamma self", "")),
        ("v1u", ("S3", int, "upper state vibrational number v1", "")),
        ("v2u", ("S2", int, "upper state vibrational number v2", "")),
        ("l2u", ("S2", int, "upper state vibrational number l2", "")),
        ("v3u", ("S2", int, "upper state vibrational number v3", "")),
        ("ru", ("S1", int, "upper state vibrational number r", "")),
        # skip 5 columns (v1l format becomes 3+5)
        ("v1l", ("S8", int, "lower state vibrational number v1", "")),
        ("v2l", ("S2", int, "lower state vibrational number v2", "")),
        ("l2l", ("S2", int, "lower state vibrational number l2", "")),
        ("v3l", ("S2", int, "lower state vibrational number v3", "")),
        ("rl", ("S1", int, "lower state vibrational number r", "")),
        ("polyu", ("S3", int, "upper state polyad", "")),
        ("wangu", ("S2", int, "upper state Wang symmetry", "")),
        ("ranku", ("S4", int, "upper state ranking number", "")),
        ("polyl", ("S3", int, "lower state polyad", "")),
        ("wangl", ("S2", int, "lower state Wang symmetry", "")),
        ("rankl", ("S4", int, "lower state ranking number", "")),
        # skip 2 columns (PQR format becomes 1+2)
        ("branch", ("S3", str, "O, P, Q, R, S branch symbol", "")),
        ("jl", ("S3", int, "lower state rotational quantum number", "")),
        ("wangl2", ("S1", str, "lower state Wang symmetry", "(e or f)")),
        ("lsrc", ("S5", int, "line source", "")),
    ]
)
...
columns_4000 = OrderedDict(
    [
        ...
        ("l2u", ("S2", int, "upper state vibrational number l2", "")),
        ("v3u", ("S2", int, "upper state vibrational number v3", "")),
        ("ru", ("S2", int, "upper state vibrational number r", "")),
        # skip 5 columns (v1l format becomes 3+3=6)
        ("v1l", ("S6", int, "lower state vibrational number v1", "")),
        ("v2l", ("S2", int, "lower state vibrational number v2", "")),
        ("l2l", ("S2", int, "lower state vibrational number l2", "")),
        ("v3l", ("S2", int, "lower state vibrational number v3", "")),
        ("rl", ("S2", int, "lower state vibrational number r", "")),
        ("polyu", ("S3", int, "upper state polyad", "")),
        ("wangu", ("S2", int, "upper state Wang symmetry", "")),
        ("ranku", ("S4", int, "upper state ranking number", "")),
        ("polyl", ("S3", int, "lower state polyad", "")),
