...
saving to disk, plot all Spectral arrays with arbitrary units.
...
class Spectrum(object):
    ...
    quantities: dict of tuples   {'quantity':(wavenum, quantity)}
        where quantities are Spectral arrays (absorbance, radiance, etc.)
    ...
    def __init__(
        ...
        self.lines = lines
        self.units = units
        """ dict: units for Spectral arrays.
        """
    ...
    def get(self, var, wunit="default", Iunit="default", copy=True):
        """Retrieve a Spectral arrays from a Spectrum object. You can select
    ...
    def savetxt(self, filename, var, wunit="default", Iunit="default"):
        """Export Spectral arrays var to filename.
    ...
    def get_vars(self, which="any"):
        """Returns all Spectral arrays stored in this object (convoluted or
        non convoluted)
    ...
    def plot(
        ...
        **kwargs: **dict
        ...
        See more examples in :ref:`the plot Spectral arrays page <label_spectrum_plot>`.
    ...
    def apply_slit(
        ...
        *args, **kwargs
        ...
        that the Spectrum is stored in, and applied to the Spectral arrays
    ...
    def line_survey(
        ...
        **kwargs
        ...
        def get_overlay(overlay):
            """Overlay line survey with a Spectral arrays (like radiance or
            transmittance)"""
    ...
    def resample(
        ...
        **kwargs: **dict
        ...
        def get_filling(variable):
            """Get out of bounds values for Spectral arrays `variable`"""
    ...
    def take(self, var):
        ...
        -------
        s: Spectrum
            same Spectrum with only the `var` Spectral arrays
    ...
    def _get_unique_var(self, operation_name="algebraic"):
        ...
        if len(quantities) > 1:
            raise KeyError(
                ...
                "one Spectral arrays you want."
            )
        elif len(quantities) == 0:
            raise KeyError(
                "No Spectral arrays defined in Spectrum {0}".format(self.get_name())
            )
        else:
            var = quantities[0]
        return var
    ...
    def max(self):
        """Maximum of the Spectrum, if only one Spectral arrays is
        available::
    ...
    def min(self):
        """Minimum of the Spectrum, if only one Spectral arrays is available
        ::
    ...
    def normalize(
        ...
        """Normalise the Spectrum, if only one Spectral arrays is available.
