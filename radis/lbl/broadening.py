...
def gamma_vald3(
    ...
    Notes
    -----
    ``gamVdW`` given in the Kurucz linelists is, as [Kurucz-and-Avrett-1981]_ state, ":math:`\\frac{\\Gamma_{W}}{N_{H}}` at 10000 K for pure hydrogen"
    ...
    .. [Kurucz-and-Avrett-1981] `"Solar Spectrum Synthesis. I. A Sample Atlas from 224 to 300 nm" <https://ui.adsabs.harvard.edu/abs/1981SAOSR.391.....K>`_
