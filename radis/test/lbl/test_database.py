...
def _run_testcases(plot=False, verbose=True, warnings=True, *args, **kwargs):
    ...
    test_load_spectrum(plot=plot, verbose=verbose, warnings=warnings,
                       *args, **kwargs)

    test_load_lines_pops(plot=plot, verbose=verbose, warnings=warnings,
                         *args, **kwargs)
