...
def test_planck_cm(verbose=True, plot=True, *args, **kwargs):
    ...
    if verbose: 
        print('Earth blackbody radiant intensity (Stefan law): {0:.2f} W/m2'.format(P_theory))
        print('Earth blackbody radiant intensity (calculated): {0:.2f} W/m2'.format(P_calc))
