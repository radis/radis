...
# Loading times only few milliseconds even for the largest HITEMP or ExoMol
# databases
#
...
#
# For instance, we plot the number of lines using Vaex's :py:func:`~vaex.viz.DataFrameAccessorViz.histogram`
...
#%%
# Or below we plot a :py:func:`~vaex.viz.DataFrameAccessorViz.heatmap` showing Self and Air-broadening coefficients
