...
sys.path.insert(0, os.path.abspath('..'))  # Allow importing RADIS

# Block downloads/network calls
os.environ["RADIS_NO_DOWNLOAD"] = "1"
os.environ["RADIS_SKIP_ONLINE_TESTS"] = "1"

# Mock compiled modules
autodoc_mock_imports = ["_radis", "joblib", "astropy", "vaex"]
